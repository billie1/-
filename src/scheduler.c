...
extern long long int localityManageTime;
extern long long int noORAMreadnum;
extern long long int LAManageTime;
extern long long int SRManageTime;
extern long long int MRManageTime;
...
extern long long int labelAllocation_cnt;
extern long long int pathReplacement_cnt1;
extern long long int pathReplacement_cnt2;
extern long long int fork_pathReplacement_cnt1;
extern long long int fork_pathReplacement_cnt2;
extern long long int noORAMreadnum;
extern long long int newdatacnt;
extern long long int newnaivedatacnt;
...
void schedule(int channel)
{
	...
	if(write_queue_length[channel] > 2*HI_WM){
		HI_WM *= 2;
		LO_WM *= 2;
	}
	if(write_queue_length[channel] > 0.5*HI_WM){
		HI_WM /= 2;
		LO_WM /= 2;
	}
...
void scheduler_stats()
{
  /* Nothing to print for now. */
	printf("LocalityManageTime\t%lld\n", localityManageTime);
	printf("AvgLocalityManageTime\t%lf\n", (double)localityManageTime/baseReadNum);
	printf("noORAMreadNum\t%lld\n", noORAMreadnum);
	printf("LAManageTime\t%lld\n", LAManageTime);
	printf("AvgLAManageTime\t%lf\n", (double)LAManageTime/baseReadNum);
	printf("SRManageTime\t%lld\n", SRManageTime);
	printf("AvgSRManageTime\t%lf\n", (double)SRManageTime/baseReadNum);
	printf("MRManageTime\t%lld\n", MRManageTime);
	printf("AvgMRManageTime\t%lf\n", (double)MRManageTime/baseReadNum);
	printf("totalcnt\t%lld\n", totalcnt);
	...
	printf("labelAllocation_cnt\t%lld\n",labelAllocation_cnt);
	printf("pathReplacement_cnt1\t%lld\n",pathReplacement_cnt1);
	printf("pathReplacement_cnt2\t%lld\n",pathReplacement_cnt2);
	printf("fork_pathReplacement_cnt1\t%lld\n",fork_pathReplacement_cnt1);
	printf("fork_pathReplacement_cnt2\t%lld\n",fork_pathReplacement_cnt2);
	printf("noORAMreadnum\t%lld\n",noORAMreadnum);
	printf("newdatacnt\t%lld\n",newdatacnt);
	printf("newnaivedatacnt\t%lld\n",newnaivedatacnt);
